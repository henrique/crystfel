...
#define INDEXING_DEFAULTS_TORCHIDX (INDEXING_TORCHIDX | INDEXING_USE_CELL_PARAMETERS)
...
typedef enum {
    ...
    INDEXING_TORCHIDX = 12, /**< Use PSI Fast Indexer (via optional library) */
...
extern struct argp torchidx_argp;
